...
@Component({
  selector: 'app-register', standalone: true, imports: [FormsModule, RouterLink, NgIf],
  template: `
...
export class RegisterComponent {
  ...
  register() {
    ...
    this.error.set('');
    this.graphql.register(this.email, this.phone, this.fullName, this.password).subscribe({
      next: (data: any) => {
